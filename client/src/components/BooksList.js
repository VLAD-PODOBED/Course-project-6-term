            ...
            <Form onSubmit={handleSubmit} className='w-100'>
                <Row>
                    <Form.Group controlId="searchTerm" className='w-100'>
                        <Form.Label>Поиск книги</Form.Label>
                        <Form.Control
                            type="text"
                ...
                <Row className='d-flex wrap'>
                    ...
                    <Col xs={70} md={15}>
                        ...
                        <Form.Group controlId="authors" className='w-100'>
                            <Form.Label>Авторы книги</Form.Label>
                            <InputGroup>
                                <FormControl
                                    type="text"
                                    placeholder="Поиск авторов книги"
                                    value={authorSearch}
                    ...
                    <Col xs={70} md={15}>
                        <Form.Group controlId="genres" className='w-100'>
                            <Form.Label>Жанры книги</Form.Label>
                            <InputGroup>
                                <FormControl
                                    type="text"
                                    placeholder="Поиск жанров книги"
                                    value={genreSearch}
                    ...
                    <Col xs={70} md={15}>
                        <Form.Group controlId="tags" className='w-100'>
                            <Form.Label>Дополнение к книги</Form.Label>
                            <InputGroup>
                                <FormControl
                                    type="text"
                                    placeholder="Поиск дополнения книги"
                                    value={tagSearch}
